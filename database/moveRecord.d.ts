...
type RecordTable = 'BurialSiteStatuses' | 'BurialSiteTypes' | 'CommittalTypes' | 'ContractTypes' | 'FeeCategories' | 'IntermentContainerTypes' | 'ServiceTypes' | 'WorkOrderMilestoneTypes' | 'WorkOrderTypes';
