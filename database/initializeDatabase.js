...
import { addBurialSiteStatus, addWorkOrderMilestoneType, addWorkOrderStatus, addWorkOrderType } from './addRecord.js';
...
const createStatements = [
  ...
  `,
    ...
    CREATE TABLE IF NOT EXISTS ContractInterments (
      ...
      deceasedAddress1 VARCHAR(50) NOT NULL,
      deceasedAddress2 VARCHAR(50) NOT NULL,
      deceasedCity VARCHAR(20) NOT NULL,
      deceasedProvince VARCHAR(2) NOT NULL,
      deceasedPostalCode VARCHAR(7) NOT NULL,
      birthDate INTEGER,
