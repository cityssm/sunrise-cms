    ...
    describe('Work Order Types', () => {
        it('Adds a new work order type', () => {
            ...
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--workOrderTypes').should('contain.text', configTables.workOrderType);
            });
        });
        it('Updates a work order type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--workOrderTypes').should('contain.text', configTables.workOrderTypeUpdated);
            });
        });
        it('Deletes a work order type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--workOrderTypes').should('not.contain.text', configTables.workOrderTypeUpdated);
            });
        });
    });
    describe('Burial Site Statuses', () => {
        it('Adds a new burial site status', () => {
            ...
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--burialSiteStatuses').should('contain.text', configTables.burialSiteStatus);
            });
        });
        it('Updates a burial site status', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--burialSiteStatuses').should('contain.text', configTables.burialSiteStatusUpdated);
            });
        });
        it('Deletes a burial site status', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--burialSiteStatuses').should('not.contain.text', configTables.burialSiteStatusUpdated);
            });
        });
    });
    describe('Committal Types', () => {
        it('Adds a new committal type', () => {
            ...
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--committalTypes').should('contain.text', configTables.committalType);
            });
        });
        it('Updates a committal type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--committalTypes').should('contain.text', configTables.committalTypeUpdated);
            });
        });
        it('Deletes a committal type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--committalTypes').should('not.contain.text', configTables.committalTypeUpdated);
            });
        });
    });
    describe('Interment Container Types', () => {
        it('Adds a new interment container type', () => {
            ...
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--intermentContainerTypes').should('contain.text', configTables.intermentContainerType);
            });
        });
        it('Updates an interment container type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--intermentContainerTypes').should('contain.text', configTables.intermentContainerTypeUpdated);
            });
        });
        it('Deletes an interment container type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--intermentContainerTypes').should('not.contain.text', configTables.intermentContainerTypeUpdated);
            });
        });
    });
});
