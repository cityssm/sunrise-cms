    ...
    describe('Work Order Types', () => {
        ...
        it('Adds a new work order type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.get('#container--workOrderTypes tr:first input[name="workOrderType"]').should('have.value', configTables.workOrderType);
            });
        });
        it('Updates a work order type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                // Find the work order type row and update it
                cy.get('#container--workOrderTypes tr:first input[name="workOrderType"]')
                ...
                cy.get('#container--workOrderTypes tr:first input[name="workOrderType"]').should('have.value', configTables.workOrderTypeUpdated);
            });
        });
    ...
    describe('Burial Site Statuses', () => {
        ...
        it('Adds a new burial site status', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--burialSiteStatuses tr:first input[name="burialSiteStatus"]').should('have.value', configTables.burialSiteStatus);
            });
        });
        it('Updates a burial site status', () => {
            cy.fixture('configTables.json').then((configTables) => {
                cy.get('#container--burialSiteStatuses tr:first input[name="burialSiteStatus"]')
                    ...
                    .click();
                cy.wait(ajaxDelayMillis);
                cy.get('#container--burialSiteStatuses tr:first input[name="burialSiteStatus"]').should('have.value', configTables.burialSiteStatusUpdated);
            });
        });
        it('Deletes a burial site status', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('.modal button[data-cy="ok"]').click();
                cy.get('#container--burialSiteStatuses tr:first input[name="burialSiteStatus"]').should('not.have.value', configTables.burialSiteStatusUpdated);
            });
        });
    });
    describe('Committal Types', () => {
        ...
        it('Adds a new committal type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--committalTypes tr:first input[name="committalType"]').should('have.value', configTables.committalType);
            });
        });
        ...
        it('Deletes a committal type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('.modal button[data-cy="ok"]').click();
                cy.get('#container--committalTypes tr:first input[name="committalType"]').should('not.have.value', configTables.committalTypeUpdated);
            });
        });
    });
    describe('Interment Container Types', () => {
        ...
        it('Adds a new interment container type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('#container--intermentContainerTypes tr:first input[name="intermentContainerType"]').should('have.value', configTables.intermentContainerType);
            });
        });
        ...
        it('Deletes an interment container type', () => {
            cy.fixture('configTables.json').then((configTables) => {
                ...
                cy.wait(ajaxDelayMillis);
                cy.get('.modal button[data-cy="ok"]').click();
                cy.get('#container--intermentContainerTypes tr:first input[name="intermentContainerType"]').should('not.have.value', configTables.intermentContainerTypeUpdated);
            });
        });
    });
});
