...
export function initializeContractTypePrints(user: User): void {
  const preneedContractTypeId =
    getCachedContractTypeByContractType('Preneed')?.contractTypeId
  ...
  const atNeedContractTypeId =
    getCachedContractTypeByContractType('At Need')?.contractTypeId
  ...
  const permitOnlyContractTypeId =
    getCachedContractTypeByContractType('Permit Only')?.contractTypeId
