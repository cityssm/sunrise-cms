...
router.post('/doCreateCemetery', updatePostHandler, handler_doCreateMap);
router.post('/doUpdateCemetery', updatePostHandler, handler_doUpdateMap);
router.post('/doDeleteCemetery', updatePostHandler, handler_doDeleteMap);
