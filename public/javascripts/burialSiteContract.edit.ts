...
;(() => {
  ...
  formElement.addEventListener('submit', (formEvent) => {
    ...
    cityssm.postJSON(
      `${los.urlPrefix}/contracts/${isCreate ? 'doCreateBurialSiteOccupancy' : 'doUpdateBurialSiteContract'}`,
      formElement,
      (rawResponseJSON) => {
  ...
  function doCopy(): void {
    cityssm.postJSON(
      `${los.urlPrefix}/contracts/doCopyBurialSiteContract`,
      {
  ...
  document
    ...
    ?.addEventListener('click', (clickEvent) => {
      ...
      function doDelete(): void {
        cityssm.postJSON(
          `${los.urlPrefix}/contracts/doDeleteBurialSiteContract`,
          {
            burialSiteContractId
          },
          (rawResponseJSON) => {
  ...
  ;(() => {
    ...
    function openEditLotOccupancyOccupant(clickEvent: Event): void {
      ...
      function editOccupant(submitEvent: SubmitEvent): void {
        ...
        cityssm.postJSON(
          `${los.urlPrefix}/contracts/doUpdateBurialSiteContractOccupant`,
          editFormElement,
          (rawResponseJSON) => {
            const responseJSON = rawResponseJSON as {
              success: boolean
    ...
    function deleteLotOccupancyOccupant(clickEvent: Event): void {
      ...
      function doDelete(): void {
        cityssm.postJSON(
          `${los.urlPrefix}/contracts/doDeleteBurialSiteContractOccupant`,
          {
            burialSiteContractId,
            lotOccupantIndex
          },
    ...
    ;(() => {
      ...
      function openEditLotOccupancyComment(clickEvent: Event): void {
        ...
        function editComment(submitEvent: SubmitEvent): void {
          ...
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doUpdateBurialSiteContractComment`,
            editFormElement,
            (rawResponseJSON) => {
              const responseJSON = rawResponseJSON as {
                success: boolean
      ...
      function deleteLotOccupancyComment(clickEvent: Event): void {
        ...
        function doDelete(): void {
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doDeleteBurialSiteContractComment`,
            {
              burialSiteContractId,
              burialSiteContractCommentId
            },
      ...
      document
        ...
        ?.addEventListener('click', () => {
          ...
          function addComment(submitEvent: SubmitEvent): void {
            ...
            cityssm.postJSON(
              `${los.urlPrefix}/contracts/doAddBurialSiteContractComment`,
              addFormElement,
              (rawResponseJSON) => {
                const responseJSON = rawResponseJSON as {
                  success: boolean
    ...
    ;(() => {
      ...
      function editLotOccupancyFeeQuantity(clickEvent: Event): void {
        ...
        function doUpdateQuantity(formEvent: SubmitEvent): void {
          ...
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doUpdateBurialSiteContractFeeQuantity`,
            formEvent.currentTarget,
            (rawResponseJSON) => {
              const responseJSON = rawResponseJSON as {
                success: boolean
      ...
      function deleteBurialSiteContractFee(clickEvent: Event): void {
        ...
        function doDelete(): void {
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doDeleteBurialSiteContractFee`,
            {
              burialSiteContractId,
              feeId
            },
      ...
      addFeeButtonElement.addEventListener('click', () => {
        ...
        function doAddFeeCategory(clickEvent: Event): void {
          ...
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doAddBurialSiteContractFeeCategory`,
            {
              burialSiteContractId,
              feeCategoryId
            },
      ...
      function deleteBurialSiteContractTransaction(clickEvent: Event): void {
        ...
        function doDelete(): void {
          cityssm.postJSON(
            `${los.urlPrefix}/contracts/doDeleteBurialSiteContractTransaction`,
            {
              burialSiteContractId,
              transactionIndex
            },
